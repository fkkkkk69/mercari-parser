...
KEYWORDS = [
    "アンダーカバー", "ナンバーナイン", "ヒステリックグラマー", "リックオウエンス",
    "ラフシモンズ", "ジェレミースコット", "ヴィヴィアンウエストウッド", "ジュンヤワタナベ",
    "コムデギャルソン", "ヘルムートラング", "モスキーノ", "バルマン", "ディーゼル",
    "グッチ", "プラダ",
    "undercover", "number nine", "hysteric glamour", "rick owens", "raf simons",
    "jeremy scott", "walter van beirendonck", "424", "gucci", "prada",
    "helmut lang", "moschino", "junya watanabe", "diesel", "balmain",
    "ppfm", "tornado mart", "vivienne westwood", "c2h4",
]
SEEN_FILE = "seen.json"
